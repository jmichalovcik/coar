...
def rule_distance(
        ...
        abs_ante_attr_diff_threshold: float = None,
        abs_succ_attr_diff_threshold: float = None,
        rel_ante_attr_diff_threshold: float = None,
        rel_succ_attr_diff_threshold: float = None,
        abs_supp_diff_threshold: float = None,
        abs_conf_diff_threshold: float = None,
) -> float:
    x = df.iloc[int(x[0])]
    y = df.iloc[int(y[0])]
